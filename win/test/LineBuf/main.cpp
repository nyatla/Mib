...
//#include <iostream>
//#include "../../../src/linebuf/GapVector.h"
//using namespace MIB;
//
///// <summary>
///// 行単位のテキストバッファアクセサです。
...
//    //class LineIter {
//    //private:
//    //    GapVector<BUFSIZE>& _ref;
//    //    int _idx;
//    //public:
//    //    LineIter(GapVector<BUFSIZE>& ref) :_ref(ref),_idx(0) {
//    //        this->_ref=ref;
//    //    };
//    //    bool next(const char* text,int& len) {
//    //        const struct MemBlockHeader* mbh;
//    //        if (!this->_ref.ptr(this->idx, 3, mbh)) {
//    //            return false;
//    //        }
//    //        len = mbh->size;
//    //        if (!this->_ref.ptr(this->idx+3,len, text)) {
//    //            return false;
//    //        }
//    //        this->idx += len + 3;
//    //        return true;
